    ...
    <div class="flex w-full h-full">
        <div class="w-1/2 h-full flex">
            <div class="w-full max-w-md m-auto">
                <a :href="'home#/editar_sondeo/' + currentSurvey.slug">
                    <button type="button" class="btn btn-primary btn-block m-2">Editar encuesta</button>
                </a>
                ...
                <div class="w-full flex p-2">
                    <div class="w-1/2 flex">
                        <span class="font-normal text-xl italic m-auto">
                            Hay {{ respondList.length }} respuestas a esta encuesta
                        </span>
                    </div>
                    <div class="w-1/2 flex">
                        <download-excel
