        ...
        methods: {
            enviarDatos() {
              ...
              Iterar sobre cualquier archivo enviado anexando los archivos a los datos del formulario.
                ...
                axios.post("api/Noticias/postNoticias",formData, {
                    headers: {
            ...
            getFiles(){
                let me=this;
                axios.post('api/Noticias/getNoticias')
                    .then(function (response) {
                        me.noticias=response.data.data
                        me.catnotRecibidas=response.data.data2
            ...
            eliminar(item){
                this.$swal.fire({
                    ...
                    if (result.value) {
                        axios.post('api/Noticias/deleteNoticias',{id:item.id})
                            .then(response => {
                                this.limpiar()
                                this.getFiles()
                                this.$swal.fire(
